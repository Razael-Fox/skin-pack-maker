  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-4">
        <div
          className={`rounded-full p-4 transition-all duration-300 ${isDragOver ? "bg-blue-500 text-white" : "bg-white/5 text-white/50 group-hover:bg-white/10 group-hover:text-white/80"}`}
        >
        ...
        <div>
          {skin.textureFile ? (
            <>
              ...
              <p
                className="mx-auto mt-2 max-w-[280px] truncate font-mono text-xs text-white/50"
